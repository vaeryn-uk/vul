...
bool TestField::RunTest(const FString& Parameters)
{
	...
	VulTest::Case(this, "Deserialize instances", [](VulTest::TC TC)
	{
		TSharedPtr<FVulFieldTestSingleInstance> Instance1;
		TSharedPtr<FVulFieldTestSingleInstance> Instance2;
		...
		TC.Equal(Instance1.Get(), Instance2.Get(), "pointers same");
	});
